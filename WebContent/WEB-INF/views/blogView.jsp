		...
		<c:forEach var="blog" items="${listBlog }">
			<div class="article-card">
					...
					<div class="card-test">
						...
						<p>Posted on <b> <c:out  value="${blog.getPsotedOn() }" /></b></p>
					</div>	
					<div class="card-buttons"> 
					<a href="edit?=<c:out value="${blog.getBlogId() }"/>"><button type="button" id="edit">Edit</button></a>  <span> | </span><a href="delete?=<c:out value="${blog.getBlogId() }"/>"><button type="button" id="delete">Delete</button></a>
				</div>
			</div>
		</c:forEach>
	</div>
